        ...
        var dfop =
            {
                ...
                url: false,
                param: null,
                cbiconpath: $.sysStaticData().urlExt +"/Content/js/wdtree/images/icons/",
            ...
            if (data && data.length > 0) {
                ...
                asnyloadc(null, false, function (data) {
                    if (data.ChildNodes && data.ChildNodes.length > 0) {
                        treenodes = data.ChildNodes;
                        dfop.data = data.ChildNodes;
                        if (dfop.description) {
                        ...
                        for (var i = 0; i < l; i++) {
                            buildnode(data.ChildNodes[i], ht, 0, i, i == l - 1);
                        }
                    }
                });
            }
